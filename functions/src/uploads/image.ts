...
export default async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    // Nhost Functions expose multipart as req.files (via busboy/multer integration)
    // For raw binary, the body is available as a Buffer on req.body
    ...
    // req.file / req.files populated by Nhost's built-in multipart handling
